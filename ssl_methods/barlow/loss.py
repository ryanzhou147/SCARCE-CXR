...
Loss:
  - Invariance:  diagonal of C should be 1
  - Decorrelation: off-diagonal of C should be 0
"""
...
class BarlowTwinsLoss(nn.Module):
    ...
    Args:
        lambda_coeff: Weight on the off-diagonal (redundancy-reduction) term.
                      Lower values more emphasis on invariance, higher values on decorrelation.
    """
